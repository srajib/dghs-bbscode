...
<tr>
					<td width="20px;" align="center"><?php echo $i.'.'; ?></td>
						...
						<td width="20px;" align="center"><?php if($AllCodes['dis']['dis_name']){ echo $AllCodes['dis']['dis_name']; } else { echo '-';} ?></td>
						<td width="20px;" align="center"><?php echo $AllCodes['upa']['district_code']; ?></td>
						<td width="20px;" align="center"><?php echo $AllCodes['upa']['upa_name']; ?></td>
