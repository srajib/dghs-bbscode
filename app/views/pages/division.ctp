...
<tr>  <td width="20px;" align="center"><?php echo $i; ?></td>
						<td width="20px;" align="center"><?php echo $AllCodes['Division']['div_code']; ?></td></td>
				
					
						   <td width="20px;" align="left" nowrap><?php if($AllCodes['Division']['div_name']){ echo $AllCodes['Division']['div_name']; } else { echo '-';} ?></td>
